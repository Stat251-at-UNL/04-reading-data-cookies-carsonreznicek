...
cookies <- cookies %>%
  mutate(
    ...
    Recipe_Index = as.factor(Recipe_Index),
    Unit = as.factor(Unit),
...
cookies_py['Ingredient'] = cookies_py['Ingredient'].astype('category')
cookies_py['Recipe_Index'] = cookies_py['Recipe_Index'].astype('category')
cookies_py['Unit'] = cookies_py['Unit'].astype('category')
cookies_py['Rating'] = pd.to_numeric(cookies_py['Rating'], errors='coerce')
cookies_py['Quantity'] = pd.to_numeric(cookies_py['Quantity'], errors='coerce')
